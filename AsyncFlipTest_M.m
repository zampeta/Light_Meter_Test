function AsyncFlipTest_M(screenid, workload, pollingwait)
...
w = PsychImaging('OpenWindow', screenid, 0, [10, 10, 1800, 1800]);
...
while ~KbCheck
    ...
    % Draw something:
    cm = 1 - cm;
    Screen('FillRect', w, [255*cm 255*cm 255*cm]);

    % Schedule new flip:
    %Screen('AsyncFlipBegin', w, tv1 + ifi/2);
    Screen('AsyncFlipBegin', w, tv1 + ifi);
